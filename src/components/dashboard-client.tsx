...
export function DashboardClient({
  ...
  stats: { total: number; inUse: number; available: number; inRepair: number, decommissioned: number };
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Currently assigned to employees</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <Card>
         ...
         <Card className="sm:col-span-2 lg:col-span-1">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">End-of-life assets</p>
          </CardContent>
        </Card>
      </div>
